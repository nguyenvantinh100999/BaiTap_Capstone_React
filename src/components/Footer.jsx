            ...
            <div className="col-4">
              <div className="about-us-footer">
                ...
                <div className="footer-info">
                  <p className="phone">(+84)37 4149 052</p>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                    ...
                    <div className="block-contact-text">
                      <p>
                        Juta - Responsive Prestashop Theme
                        <br />
                      ...
                      <p>
                        Call us: <span>(012) 800 456 789-987 </span>
                      </p>
                      <p>
                        Email us: <span>demo@posthemes.com</span>
                      </p>
                    </div>
                    <div className="time">
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <div className="copyright">
                Copyright © <a href="#">Tình</a>. All Rights Reserved
              </div>
            </div>
            <div className="col-lg-6 col-md-6">
